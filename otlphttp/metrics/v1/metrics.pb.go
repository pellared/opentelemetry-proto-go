...
// 	protoc        v7.35.0
// source: opentelemetry/proto/otlphttp/metrics/v1/metrics.proto

package v1

import (
	v11 "go.opentelemetry.io/proto/otlphttp/common/v1"
	v1 "go.opentelemetry.io/proto/otlphttp/resource/v1"
...
func (AggregationTemporality) Descriptor() protoreflect.EnumDescriptor {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_enumTypes[0].Descriptor()
}

func (AggregationTemporality) Type() protoreflect.EnumType {
	return &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_enumTypes[0]
}
...
func (AggregationTemporality) EnumDescriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{0}
}
...
func (DataPointFlags) Descriptor() protoreflect.EnumDescriptor {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_enumTypes[1].Descriptor()
}

func (DataPointFlags) Type() protoreflect.EnumType {
	return &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_enumTypes[1]
}
...
func (DataPointFlags) EnumDescriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{1}
}
...
func (x *MetricsData) Reset() {
	*x = MetricsData{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[0]
...
func (x *ResourceMetrics) Reset() {
	*x = ResourceMetrics{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ScopeMetrics) Reset() {
	*x = ScopeMetrics{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScopeMetrics) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{2}
}
...
func (x *Metric) Reset() {
	*x = Metric{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Metric) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{3}
}
...
func (x *Gauge) Reset() {
	*x = Gauge{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Gauge) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{4}
}
...
type Sum struct {
	...
	AggregationTemporality AggregationTemporality `protobuf:"varint,2,opt,name=aggregation_temporality,json=aggregationTemporality,proto3,enum=opentelemetry.proto.otlphttp.metrics.v1.AggregationTemporality" json:"aggregation_temporality,omitempty"`
...
func (x *Sum) Reset() {
	*x = Sum{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Sum) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{5}
}
...
func (x *Histogram) Reset() {
	*x = Histogram{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Histogram) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{6}
}
...
func (x *ExponentialHistogram) Reset() {
	*x = ExponentialHistogram{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExponentialHistogram) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{7}
}
...
func (x *Summary) Reset() {
	*x = Summary{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Summary) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{8}
}
...
func (x *NumberDataPoint) Reset() {
	*x = NumberDataPoint{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NumberDataPoint) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{9}
}
...
func (x *HistogramDataPoint) Reset() {
	*x = HistogramDataPoint{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HistogramDataPoint) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{10}
}
...
func (x *ExponentialHistogramDataPoint) Reset() {
	*x = ExponentialHistogramDataPoint{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExponentialHistogramDataPoint) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{11}
}
...
func (x *SummaryDataPoint) Reset() {
	*x = SummaryDataPoint{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SummaryDataPoint) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{12}
}
...
func (x *Exemplar) Reset() {
	*x = Exemplar{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Exemplar) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{13}
}
...
func (x *ExponentialHistogramDataPoint_Buckets) Reset() {
	*x = ExponentialHistogramDataPoint_Buckets{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExponentialHistogramDataPoint_Buckets) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{11, 0}
}
...
func (x *SummaryDataPoint_ValueAtQuantile) Reset() {
	*x = SummaryDataPoint_ValueAtQuantile{}
	mi := &file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SummaryDataPoint_ValueAtQuantile) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP(), []int{12, 0}
}
...
var File_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto protoreflect.FileDescriptor

const file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDesc = "" +
	"\n" +
	"5opentelemetry/proto/otlphttp/metrics/v1/metrics.proto\x12'opentelemetry.proto.otlphttp.metrics.v1\x1a3opentelemetry/proto/otlphttp/common/v1/common.proto\x1a7opentelemetry/proto/otlphttp/resource/v1/resource.proto\"r\n" +
	"\vMetricsData\x12c\n" +
	"\x10resource_metrics\x18\x01 \x03(\v28.opentelemetry.proto.otlphttp.metrics.v1.ResourceMetricsR\x0fresourceMetrics\"\xe4\x01\n" +
	"\x0fResourceMetrics\x12N\n" +
	"\bresource\x18\x01 \x01(\v22.opentelemetry.proto.otlphttp.resource.v1.ResourceR\bresource\x12Z\n" +
	"\rscope_metrics\x18\x02 \x03(\v25.opentelemetry.proto.otlphttp.metrics.v1.ScopeMetricsR\fscopeMetrics\x12\x1d\n" +
	"\n" +
	"schema_url\x18\x03 \x01(\tR\tschemaUrlJ\x06\b\xe8\a\x10\xe9\a\"\xcc\x01\n" +
	"\fScopeMetrics\x12R\n" +
	"\x05scope\x18\x01 \x01(\v2<.opentelemetry.proto.otlphttp.common.v1.InstrumentationScopeR\x05scope\x12I\n" +
	"\ametrics\x18\x02 \x03(\v2/.opentelemetry.proto.otlphttp.metrics.v1.MetricR\ametrics\x12\x1d\n" +
	"\n" +
	"schema_url\x18\x03 \x01(\tR\tschemaUrl\"\xdc\x04\n" +
	"\x06Metric\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x12\n" +
	"\x04unit\x18\x03 \x01(\tR\x04unit\x12F\n" +
	"\x05gauge\x18\x05 \x01(\v2..opentelemetry.proto.otlphttp.metrics.v1.GaugeH\x00R\x05gauge\x12@\n" +
	"\x03sum\x18\a \x01(\v2,.opentelemetry.proto.otlphttp.metrics.v1.SumH\x00R\x03sum\x12R\n" +
	"\thistogram\x18\t \x01(\v22.opentelemetry.proto.otlphttp.metrics.v1.HistogramH\x00R\thistogram\x12t\n" +
	"\x15exponential_histogram\x18\n" +
	" \x01(\v2=.opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogramH\x00R\x14exponentialHistogram\x12L\n" +
	"\asummary\x18\v \x01(\v20.opentelemetry.proto.otlphttp.metrics.v1.SummaryH\x00R\asummary\x12L\n" +
	"\bmetadata\x18\f \x03(\v20.opentelemetry.proto.otlphttp.common.v1.KeyValueR\bmetadataB\x06\n" +
	"\x04dataJ\x04\b\x04\x10\x05J\x04\b\x06\x10\aJ\x04\b\b\x10\t\"b\n" +
	"\x05Gauge\x12Y\n" +
	"\vdata_points\x18\x01 \x03(\v28.opentelemetry.proto.otlphttp.metrics.v1.NumberDataPointR\n" +
	"dataPoints\"\xfd\x01\n" +
	"\x03Sum\x12Y\n" +
	"\vdata_points\x18\x01 \x03(\v28.opentelemetry.proto.otlphttp.metrics.v1.NumberDataPointR\n" +
	"dataPoints\x12x\n" +
	"\x17aggregation_temporality\x18\x02 \x01(\x0e2?.opentelemetry.proto.otlphttp.metrics.v1.AggregationTemporalityR\x16aggregationTemporality\x12!\n" +
	"\fis_monotonic\x18\x03 \x01(\bR\visMonotonic\"\xe3\x01\n" +
	"\tHistogram\x12\\\n" +
	"\vdata_points\x18\x01 \x03(\v2;.opentelemetry.proto.otlphttp.metrics.v1.HistogramDataPointR\n" +
	"dataPoints\x12x\n" +
	"\x17aggregation_temporality\x18\x02 \x01(\x0e2?.opentelemetry.proto.otlphttp.metrics.v1.AggregationTemporalityR\x16aggregationTemporality\"\xf9\x01\n" +
	"\x14ExponentialHistogram\x12g\n" +
	"\vdata_points\x18\x01 \x03(\v2F.opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogramDataPointR\n" +
	"dataPoints\x12x\n" +
	"\x17aggregation_temporality\x18\x02 \x01(\x0e2?.opentelemetry.proto.otlphttp.metrics.v1.AggregationTemporalityR\x16aggregationTemporality\"e\n" +
	"\aSummary\x12Z\n" +
	"\vdata_points\x18\x01 \x03(\v29.opentelemetry.proto.otlphttp.metrics.v1.SummaryDataPointR\n" +
	"dataPoints\"\xe8\x02\n" +
	"\x0fNumberDataPoint\x12P\n" +
	"\n" +
	"attributes\x18\a \x03(\v20.opentelemetry.proto.otlphttp.common.v1.KeyValueR\n" +
	"attributes\x12/\n" +
	...
	"\x06as_int\x18\x06 \x01(\x10H\x00R\x05asInt\x12O\n" +
	"\texemplars\x18\x05 \x03(\v21.opentelemetry.proto.otlphttp.metrics.v1.ExemplarR\texemplars\x12\x14\n" +
	"\x05flags\x18\b \x01(\rR\x05flagsB\a\n" +
	"\x05valueJ\x04\b\x01\x10\x02\"\xeb\x03\n" +
	"\x12HistogramDataPoint\x12P\n" +
	"\n" +
	"attributes\x18\t \x03(\v20.opentelemetry.proto.otlphttp.common.v1.KeyValueR\n" +
	"attributes\x12/\n" +
	"\x14start_time_unix_nano\x18\x02 \x01(\x06R\x11startTimeUnixNano\x12$\n" +
	...
	"\x0fexplicit_bounds\x18\a \x03(\x01R\x0eexplicitBounds\x12O\n" +
	"\texemplars\x18\b \x03(\v21.opentelemetry.proto.otlphttp.metrics.v1.ExemplarR\texemplars\x12\x14\n" +
	"\x05flags\x18\n" +
	...
	"\x04_sumB\x06\n" +
	"\x04_minB\x06\n" +
	"\x04_maxJ\x04\b\x01\x10\x02\"\x9e\x06\n" +
	"\x1dExponentialHistogramDataPoint\x12P\n" +
	"\n" +
	"attributes\x18\x01 \x03(\v20.opentelemetry.proto.otlphttp.common.v1.KeyValueR\n" +
	"attributes\x12/\n" +
	"\x14start_time_unix_nano\x18\x02 \x01(\x06R\x11startTimeUnixNano\x12$\n" +
	"\x0etime_unix_nano\x18\x03 \x01(\x06R\ftimeUnixNano\x12\x14\n" +
	"\x05count\x18\x04 \x01(\x06R\x05count\x12\x15\n" +
	...
	"\n" +
	"zero_count\x18\a \x01(\x06R\tzeroCount\x12j\n" +
	"\bpositive\x18\b \x01(\v2N.opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogramDataPoint.BucketsR\bpositive\x12j\n" +
	"\bnegative\x18\t \x01(\v2N.opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogramDataPoint.BucketsR\bnegative\x12\x14\n" +
	"\x05flags\x18\n" +
	" \x01(\rR\x05flags\x12O\n" +
	"\texemplars\x18\v \x03(\v21.opentelemetry.proto.otlphttp.metrics.v1.ExemplarR\texemplars\x12\x15\n" +
	...
	"\x03sum\x18\x05 \x01(\x01R\x03sum\x12r\n" +
	"\x0fquantile_values\x18\x06 \x03(\v2I.opentelemetry.proto.otlphttp.metrics.v1.SummaryDataPoint.ValueAtQuantileR\x0equantileValues\x12\x14\n" +
	"\x05flags\x18\b \x01(\rR\x05flags\x1aC\n" +
	"\x0fValueAtQuantile\x12\x1a\n" +
	"\bquantile\x18\x01 \x01(\x01R\bquantile\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05valueJ\x04\b\x01\x10\x02\"\x8e\x02\n" +
	"\bExemplar\x12a\n" +
	"\x13filtered_attributes\x18\a \x03(\v20.opentelemetry.proto.otlphttp.common.v1.KeyValueR\x12filteredAttributes\x12$\n" +
	...
	"'DATA_POINT_FLAGS_NO_RECORDED_VALUE_MASK\x10\x01B\x83\x01\n" +
	"!io.opentelemetry.proto.metrics.v1B\fMetricsProtoP\x01Z-go.opentelemetry.io/proto/otlphttp/metrics/v1\xaa\x02\x1eOpenTelemetry.Proto.Metrics.V1b\x06proto3"

var (
	file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescOnce sync.Once
	file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescData []byte
)

func file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescGZIP() []byte {
	file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescOnce.Do(func() {
		file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDesc), len(file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDesc)))
	})
	return file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDescData
}

var file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_goTypes = []any{
	(AggregationTemporality)(0),                   // 0: opentelemetry.proto.otlphttp.metrics.v1.AggregationTemporality
	(DataPointFlags)(0),                           // 1: opentelemetry.proto.otlphttp.metrics.v1.DataPointFlags
	(*MetricsData)(nil),                           // 2: opentelemetry.proto.otlphttp.metrics.v1.MetricsData
	(*ResourceMetrics)(nil),                       // 3: opentelemetry.proto.otlphttp.metrics.v1.ResourceMetrics
	(*ScopeMetrics)(nil),                          // 4: opentelemetry.proto.otlphttp.metrics.v1.ScopeMetrics
	(*Metric)(nil),                                // 5: opentelemetry.proto.otlphttp.metrics.v1.Metric
	(*Gauge)(nil),                                 // 6: opentelemetry.proto.otlphttp.metrics.v1.Gauge
	(*Sum)(nil),                                   // 7: opentelemetry.proto.otlphttp.metrics.v1.Sum
	(*Histogram)(nil),                             // 8: opentelemetry.proto.otlphttp.metrics.v1.Histogram
	(*ExponentialHistogram)(nil),                  // 9: opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogram
	(*Summary)(nil),                               // 10: opentelemetry.proto.otlphttp.metrics.v1.Summary
	(*NumberDataPoint)(nil),                       // 11: opentelemetry.proto.otlphttp.metrics.v1.NumberDataPoint
	(*HistogramDataPoint)(nil),                    // 12: opentelemetry.proto.otlphttp.metrics.v1.HistogramDataPoint
	(*ExponentialHistogramDataPoint)(nil),         // 13: opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogramDataPoint
	(*SummaryDataPoint)(nil),                      // 14: opentelemetry.proto.otlphttp.metrics.v1.SummaryDataPoint
	(*Exemplar)(nil),                              // 15: opentelemetry.proto.otlphttp.metrics.v1.Exemplar
	(*ExponentialHistogramDataPoint_Buckets)(nil), // 16: opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogramDataPoint.Buckets
	(*SummaryDataPoint_ValueAtQuantile)(nil),      // 17: opentelemetry.proto.otlphttp.metrics.v1.SummaryDataPoint.ValueAtQuantile
	(*v1.Resource)(nil),                           // 18: opentelemetry.proto.otlphttp.resource.v1.Resource
	(*v11.InstrumentationScope)(nil),              // 19: opentelemetry.proto.otlphttp.common.v1.InstrumentationScope
	(*v11.KeyValue)(nil),                          // 20: opentelemetry.proto.otlphttp.common.v1.KeyValue
}
var file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_depIdxs = []int32{
	3,  // 0: opentelemetry.proto.otlphttp.metrics.v1.MetricsData.resource_metrics:type_name -> opentelemetry.proto.otlphttp.metrics.v1.ResourceMetrics
	18, // 1: opentelemetry.proto.otlphttp.metrics.v1.ResourceMetrics.resource:type_name -> opentelemetry.proto.otlphttp.resource.v1.Resource
	4,  // 2: opentelemetry.proto.otlphttp.metrics.v1.ResourceMetrics.scope_metrics:type_name -> opentelemetry.proto.otlphttp.metrics.v1.ScopeMetrics
	19, // 3: opentelemetry.proto.otlphttp.metrics.v1.ScopeMetrics.scope:type_name -> opentelemetry.proto.otlphttp.common.v1.InstrumentationScope
	5,  // 4: opentelemetry.proto.otlphttp.metrics.v1.ScopeMetrics.metrics:type_name -> opentelemetry.proto.otlphttp.metrics.v1.Metric
	6,  // 5: opentelemetry.proto.otlphttp.metrics.v1.Metric.gauge:type_name -> opentelemetry.proto.otlphttp.metrics.v1.Gauge
	7,  // 6: opentelemetry.proto.otlphttp.metrics.v1.Metric.sum:type_name -> opentelemetry.proto.otlphttp.metrics.v1.Sum
	8,  // 7: opentelemetry.proto.otlphttp.metrics.v1.Metric.histogram:type_name -> opentelemetry.proto.otlphttp.metrics.v1.Histogram
	9,  // 8: opentelemetry.proto.otlphttp.metrics.v1.Metric.exponential_histogram:type_name -> opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogram
	10, // 9: opentelemetry.proto.otlphttp.metrics.v1.Metric.summary:type_name -> opentelemetry.proto.otlphttp.metrics.v1.Summary
	20, // 10: opentelemetry.proto.otlphttp.metrics.v1.Metric.metadata:type_name -> opentelemetry.proto.otlphttp.common.v1.KeyValue
	11, // 11: opentelemetry.proto.otlphttp.metrics.v1.Gauge.data_points:type_name -> opentelemetry.proto.otlphttp.metrics.v1.NumberDataPoint
	11, // 12: opentelemetry.proto.otlphttp.metrics.v1.Sum.data_points:type_name -> opentelemetry.proto.otlphttp.metrics.v1.NumberDataPoint
	0,  // 13: opentelemetry.proto.otlphttp.metrics.v1.Sum.aggregation_temporality:type_name -> opentelemetry.proto.otlphttp.metrics.v1.AggregationTemporality
	12, // 14: opentelemetry.proto.otlphttp.metrics.v1.Histogram.data_points:type_name -> opentelemetry.proto.otlphttp.metrics.v1.HistogramDataPoint
	0,  // 15: opentelemetry.proto.otlphttp.metrics.v1.Histogram.aggregation_temporality:type_name -> opentelemetry.proto.otlphttp.metrics.v1.AggregationTemporality
	13, // 16: opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogram.data_points:type_name -> opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogramDataPoint
	0,  // 17: opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogram.aggregation_temporality:type_name -> opentelemetry.proto.otlphttp.metrics.v1.AggregationTemporality
	14, // 18: opentelemetry.proto.otlphttp.metrics.v1.Summary.data_points:type_name -> opentelemetry.proto.otlphttp.metrics.v1.SummaryDataPoint
	20, // 19: opentelemetry.proto.otlphttp.metrics.v1.NumberDataPoint.attributes:type_name -> opentelemetry.proto.otlphttp.common.v1.KeyValue
	15, // 20: opentelemetry.proto.otlphttp.metrics.v1.NumberDataPoint.exemplars:type_name -> opentelemetry.proto.otlphttp.metrics.v1.Exemplar
	20, // 21: opentelemetry.proto.otlphttp.metrics.v1.HistogramDataPoint.attributes:type_name -> opentelemetry.proto.otlphttp.common.v1.KeyValue
	15, // 22: opentelemetry.proto.otlphttp.metrics.v1.HistogramDataPoint.exemplars:type_name -> opentelemetry.proto.otlphttp.metrics.v1.Exemplar
	20, // 23: opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogramDataPoint.attributes:type_name -> opentelemetry.proto.otlphttp.common.v1.KeyValue
	16, // 24: opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogramDataPoint.positive:type_name -> opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogramDataPoint.Buckets
	16, // 25: opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogramDataPoint.negative:type_name -> opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogramDataPoint.Buckets
	15, // 26: opentelemetry.proto.otlphttp.metrics.v1.ExponentialHistogramDataPoint.exemplars:type_name -> opentelemetry.proto.otlphttp.metrics.v1.Exemplar
	20, // 27: opentelemetry.proto.otlphttp.metrics.v1.SummaryDataPoint.attributes:type_name -> opentelemetry.proto.otlphttp.common.v1.KeyValue
	17, // 28: opentelemetry.proto.otlphttp.metrics.v1.SummaryDataPoint.quantile_values:type_name -> opentelemetry.proto.otlphttp.metrics.v1.SummaryDataPoint.ValueAtQuantile
	20, // 29: opentelemetry.proto.otlphttp.metrics.v1.Exemplar.filtered_attributes:type_name -> opentelemetry.proto.otlphttp.common.v1.KeyValue
...
func init() { file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_init() }
func file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_init() {
	if File_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto != nil {
		return
	}
	file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[3].OneofWrappers = []any{
		(*Metric_Gauge)(nil),
		(*Metric_Sum)(nil),
	...
	file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[9].OneofWrappers = []any{
		(*NumberDataPoint_AsDouble)(nil),
		(*NumberDataPoint_AsInt)(nil),
	}
	file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[10].OneofWrappers = []any{}
	file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[11].OneofWrappers = []any{}
	file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes[13].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDesc), len(file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_goTypes,
		DependencyIndexes: file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_depIdxs,
		EnumInfos:         file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_enumTypes,
		MessageInfos:      file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_msgTypes,
	}.Build()
	File_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto = out.File
	file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_goTypes = nil
	file_opentelemetry_proto_otlphttp_metrics_v1_metrics_proto_depIdxs = nil
}
